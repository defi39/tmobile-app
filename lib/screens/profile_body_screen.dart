              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('065120158', style: vkTextCardBold),
                    const SizedBox(
                      width: 9.0,
                    ),
                    const Icon(
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Sri Defi', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Defi', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xffee8301)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                    'KP.Teggallega Permai Jl.Andesit Blok D1 No. 03, Kecamatan Nanggung, Kabupaten Bogor',
